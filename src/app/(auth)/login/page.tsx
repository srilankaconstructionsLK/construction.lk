...
import { Mail, Lock, Eye, Smartphone } from 'lucide-react';
      ...
      >
        <div className="w-full max-w-[400px] space-y-8 py-8">
          <div className="space-y-2">
            <h1 className="font-display text-3xl font-extrabold text-secondary tracking-tight">Welcome Back</h1>
            <p className="text-secondary/50 font-medium text-sm">Access your industrial dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot-password" className="text-[9px] font-bold uppercase tracking-widest text-primary-container hover:underline">
                  Forgot?
                </Link>
              </div>
              <div className="relative group">
                ...
                />
                <button className="absolute right-3.5 top-1/2 -translate-y-1/2 text-outline hover:text-secondary transition-colors" type="button">
          ...
          <div className="relative flex items-center py-2">
            ...
            <span className="flex-shrink mx-4 text-[9px] font-bold text-secondary/30 uppercase tracking-[0.3em]">Sign In Via</span>
            <div className="flex-grow border-t border-surface-variant"></div>
          </div>
          ...
          <div className="pt-6 text-center">
             <p className="text-xs text-secondary/40 font-medium">
              New to the network? <Link href="/register" className="text-primary-container hover:underline font-bold uppercase tracking-widest ml-1">Join Now</Link>
            </p>
          </div>
        </div>
